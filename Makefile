...
# 我写的
	@mockgen -source=02webook/internal/service/article.go -package=svcmocks -destination=02webook/internal/service/mocks/article.mock.go
	@mockgen -source=02webook/internal/repository/article/article.go -package=artrepomocks -destination=02webook/internal/repository/article/mocks/article.mock.go
	...
	@mockgen -source=02webook/internal/repository/article/article_reader.go -package=artrepomocks -destination=02webook/internal/repository/article/mocks/article_reader.mock.go
	@go mod tidy