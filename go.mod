...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.903
...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.23.0-rc.1 // indirect
